...
<nav class="navbar navbar-default navbar-fixed-bottom">
    <div class="container-fluid text-center">
        ...
        <div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo U('Service/fuwu');?>" class="navbar-link">服务</a></p>
        </div>
        <div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo U('Business/faxian');?>" class="navbar-link">发现</a></p>
        </div>
        <div class="col-xs-3">
    ...
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Zhushou/index');?>">
