...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="user_tel" value="<?php echo ((isset($info["user_tel"]) && ($info["user_tel"] !== ""))?($info["user_tel"]):''); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
               <!-- <input type="text" class="text input-small" name="content" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):''); ?>">-->
                <textarea rows="6" cols="60" name="content"><?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?></textarea>
            </div>
        </div>
        <div class="form-item">
